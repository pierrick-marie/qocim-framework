...
import application.utils.SubscriptionFilterQuestion1;
...
public class Main {
	...
	SubscriptionFilterQuestion1 filter;

	contextApplication = new BasicContextApplication(_args);

	{
	    // TODO To answer to the question 2 of the exercise 3, comment the
	    // following instruction
	    filter = new SubscriptionFilterQuestion1();
	    // TODO: To answer to the question 2 of the exercise 3, uncomment
	    // the following instruction
	    // filter = new SubscriptionFilterQuestion2();
	}
