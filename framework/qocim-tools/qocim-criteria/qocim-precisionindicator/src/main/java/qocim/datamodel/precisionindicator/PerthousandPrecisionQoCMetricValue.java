...
public class PerthousandPrecisionQoCMetricValue extends QoCMetricValue {

	// # # # # # CONSTRUCTORS # # # # #

	protected PerthousandPrecisionQoCMetricValue() {
	...
	public void setValue(final Double _value) {
		...
		try {
			ConstraintChecker.doubleIsBetweenBounds(_value,
					PerthousandPrecisionQoCMetricDefinition.MIN_VALUE_DEFAULTVALUE,
					PerthousandPrecisionQoCMetricDefinition.MAX_VALUE_DEFAULTVALUE,
