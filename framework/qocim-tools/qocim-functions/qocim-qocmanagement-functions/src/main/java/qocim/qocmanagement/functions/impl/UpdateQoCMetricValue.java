...
public class UpdateQoCMetricValue implements IQoCManagementFunction {
	...
	private void updateQoCIndicator(final ContextObservation<?> _contextObservation) {
		...
		if (found_qoCIndicator != null) {
			...
			if (old_qoCMetricValue != null) {
				updateQoCMetricValue(_contextObservation, found_qoCIndicator, old_qoCMetricValue);
			}
		}
	}
	 ...
	 */
	private void updateQoCMetricValue(final ContextObservation<?> _contextObservation, final QoCIndicator _qoCIndicator,
