...
public class TestCriterionZeroQoCMetricDefinition extends QoCMetricDefinition {

	// # # # # # CONSTANTS # # # # #

	public static final String ID_DEFAULTVALUE = "0.1";
	...
	public TestCriterionZeroQoCMetricDefinition() {
		// - - - - - CORE OF THE METHOD - - - - -
		super();
		id(ID_DEFAULTVALUE);
		...
		description(new TestCriterionZeroDescription());
	...
	@Override
	public Double computeQoCMetricValue(final QInformation<?> infrmation,
