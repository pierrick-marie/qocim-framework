...
public class CDFMFunction implements ICDFMFunction {
	 ...
	 */
	private qocim.cdfm.function.IAgregationOperator operator;
	/**
	...
	@Override
	public ICDFMFunction setOperator(final qocim.cdfm.function.IAgregationOperator _operator) {
		// - - - - - CHECK THE VALUE OF THE ARGUMENTS - - - - -
		try {
	...
	@Override
	public qocim.cdfm.function.IAgregationOperator operator() {
		// - - - - - RETURN STATEMENT - - - - -
