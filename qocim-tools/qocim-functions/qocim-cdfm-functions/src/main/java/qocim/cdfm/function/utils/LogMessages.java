 ...
 * Contributor(s): 
 */
package qocim.cdfm.function.utils;
...
public class LogMessages {
    ...
    public final static String GET_OPERATOR = " - Get operator: ";

    public final static String SET_RESULT_LISTENER = " - Set result listener: ";

    public final static String GET_RESULT_LISTENER = " - Get result listener: ";

    public final static String SET_TIME_TO_WAIT = " - Set result listener: ";
