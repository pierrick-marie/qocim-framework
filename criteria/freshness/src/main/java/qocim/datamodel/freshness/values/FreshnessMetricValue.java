 ...
 * Contributor(s):
 */
package qocim.datamodel.freshness.values;
...
public class FreshnessMetricValue extends QoCMetricValue {
	...
	private Double parseValue(Object value) {
		...
		try {
			...
			QoCIMLogger.error("FreshnessMetricValue.parseValue: " + value.getClass().getName()
